...
<body>
  ...
  <section id="admin" class="putih">
    ...
    <form method="post" action="{{ route('change-userpassword') }}" class="row g-3">
      @csrf
      <div class="mb-3 row">
      ...
      <div class="row">
        <div class="col-sm-12 form-group mb-0">
          <button class="btn btn-success float-center mt-1">Ubah Password</button>
        </div>
        <div class="col-sm-12 form-group mb-0">
          <button class="btn btn-warning float-center mt-1"><a>Kembali</a></button>
        </div>
      </div>
